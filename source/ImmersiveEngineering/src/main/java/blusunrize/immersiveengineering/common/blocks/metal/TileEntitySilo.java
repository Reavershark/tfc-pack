...
//	ItemStack prevOutputStack;
	...
	public static class SiloInventoryHandler implements IItemHandler
	{
		...
		public ItemStack insertItem(int slot, ItemStack stack, boolean simulate)
		{
            ...
            if (sizeCap != null)
                if (!sizeCap.getSize(stack).isSmallerThan(Size.LARGE))
                    return stack;
        ...
        //    IItemSize sizeCap = CapabilityItemSize.getIItemSize(stack);
        //    if (sizeCap != null)
        //        canFit = sizeCap.getSize(stack).isSmallerThan(Size.LARGE);
        //    return slot == 0 && ItemStack.areItemsEqual(stack, silo.identStack) && canFit;
        //}
	}
