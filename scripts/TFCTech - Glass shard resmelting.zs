...
import mods.tfctech.SmelteryRecipeBuilder;
...
val builder = Smeltery.addRecipe("glass_shard", <liquid:glass>*1000, 800); // recipe name, millibuckets, melting temperature
